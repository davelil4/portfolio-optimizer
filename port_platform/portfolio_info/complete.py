...
import portfolio_info.layout as lay
import portfolio_info.linprog as lp
    ...
    dbc.Row(
        [
            dbc.Col(
                [
                    dbc.Stack([
                        dcc.Dropdown(id="ticker-asset",options=dg.stock_symbols,placeholder="Select a Stock", style={"color": "black"}, value="MSFT"),
